...
const NewsPage = () => {
  ...
  const filterPosts = allPost.filter((i) =>
    i.title.toLowerCase().includes(searchInput)
  );

  // Decide which posts to display
  const displayPosts = searchInput ? filterPosts : posts;
  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto py-10 px-4">
        ...
        {searchInput && filterPosts.length === 0 && (
          <p className="text-center text-gray-500 mt-6">No search result found</p>
        )}
